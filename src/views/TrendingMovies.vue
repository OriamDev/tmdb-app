...
export default {
  ...
  methods: {
    getMovies: async function () {
      for (let i = 1; i <= 5; i++)
      {
        let response = await fetch('https://api.themoviedb.org/3/trending/movie/day?api_key=2d9bfcad2b670144f0f5a21c96686090&page=' + i)
    ...
    getGenres: async function () {
      const response = await fetch('https://api.themoviedb.org/3/genre/movie/list?api_key=2d9bfcad2b670144f0f5a21c96686090')
      const data = await response.json()
